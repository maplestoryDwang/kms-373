...
public class CubeOption {
   public static int getRedCubePotentialId(int itemid, int grade, int num, int... args) {
      ...
      type = !GameConstants.isWeapon(itemid) && !GameConstants.isSecondaryWeapon(itemid) ? (!GameConstants.isCap(itemid) ? (!GameConstants.isCape(itemid) ? (type != 1132 && type != 1152 ? (GameConstants.isLongcoat(itemid) || type >= 1040 && type <= 1042 ? 1042 : (type >= 1070 && type <= 1073 ? 1073 : (type >= 1080 && type <= 1082 ? 1082 : (type >= 1061 && type <= 1063 ? 1062 : (type != 1672 ? (type != 1190 && type != 1191 ? 1122 : 1190) : 1672))))) : 1132) : 1102) : 1004) : 1302;
      if (grade != 1) {
         if (grade != 2) {
            if (grade != 3) {
               if (grade == 4) {
      ...
      if (MapleItemInformationProvider.getInstance().getReqLevel(itemid) < 80) {
         ...
         if (potentialid == 203) {
            potentialid = MapleItemInformationProvider.getInstance().getReqLevel(itemid) != 10 ? 201 : 1;
         }
      }
   ...
   public static int getPlatinumUnlimitiedCubePotentialId(int itemid, int grade, int num, int... args) {
      LinkedHashMap<Integer, Integer> list = new LinkedHashMap();
      int potentialid = 0;
      int type = itemid / 1000;
      type = !GameConstants.isWeapon(itemid) && !GameConstants.isSecondaryWeapon(itemid) ? (GameConstants.isCap(itemid) ? 1004 : (GameConstants.isCape(itemid) ? 1102 : (type != 1132 && type != 1152 ? (GameConstants.isLongcoat(itemid) || type >= 1040 && type <= 1042 ? 1042 : (type >= 1070 && type <= 1073 ? 1073 : (type >= 1080 && type <= 1082 ? 1082 : (type >= 1061 && type <= 1063 ? 1062 : (type == 1672 ? 1672 : (type != 1190 && type != 1191 ? 1122 : 1190)))))) : 1132))) : 1302;
      if (grade == 4) {
         switch(type) {
         case 1004:
            if (num == 1) {
   ...
   public static int getUnlimitiedCubePotentialId(int itemid, int grade, int num, int... args) {
      ...
      Iterator var14 = list.entrySet().iterator();

      while(var14.hasNext()) {
         Entry l = (Entry)var14.next();
