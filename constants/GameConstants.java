...
public class GameConstants {
   ...
   public static final Integer[] cashBlock;
   ...
   public static final List<Pair<String, String>> dList;
   ...
   public static final int[] showEffectDropItems;
   public static final int[][] StarInfo;
   public static List<Integer> questReader;
   public static final Map<Integer, Integer> price;
   public static final List<DailyGiftItemInfo> dailyItems;
   public static final List<Triple<Integer, Integer, Integer>> chariotItems;
   ...
   public static int getMonsterHP(int level) {
      return level >= 0 && level < mobHpVal.length ? mobHpVal[level] : Integer.MAX_VALUE;
   }
   ...
   public static boolean JobCodeCheck(int firstjob, int secondjob) {
      if (isHero(firstjob) && isHero(secondjob)) {
         return true;
      } else if (isPaladin(firstjob) && isPaladin(secondjob)) {
         return true;
      } else if (isDarkKnight(firstjob) && isDarkKnight(secondjob)) {
         return true;
      } else if (isFPMage(firstjob) && isFPMage(secondjob)) {
         return true;
      } else if (isILMage(firstjob) && isILMage(secondjob)) {
         return true;
      } else if (isBishop(firstjob) && isBishop(secondjob)) {
         return true;
      } else if (isPathFinder(firstjob) && isPathFinder(secondjob)) {
         return true;
      } else if (isBowMaster(firstjob) && isBowMaster(secondjob)) {
         return true;
      } else if (isMarksMan(firstjob) && isMarksMan(secondjob)) {
         return true;
      } else if (isNightLord(firstjob) && isNightLord(secondjob)) {
         return true;
      } else if (isShadower(firstjob) && isShadower(secondjob)) {
         return true;
      } else if (isDualBlade(firstjob) && isDualBlade(secondjob)) {
         return true;
      } else if (isViper(firstjob) && isViper(secondjob)) {
         return true;
      } else if (isCaptain(firstjob) && isCaptain(secondjob)) {
         return true;
      } else if (isCannon(firstjob) && isCannon(secondjob)) {
         return true;
      } else if (isSoulMaster(firstjob) && isSoulMaster(secondjob)) {
         return true;
      } else if (isFlameWizard(firstjob) && isFlameWizard(secondjob)) {
         return true;
      } else if (isWindBreaker(firstjob) && isWindBreaker(secondjob)) {
         return true;
      } else if (isNightWalker(firstjob) && isNightWalker(secondjob)) {
         return true;
      } else if (isStriker(firstjob) && isStriker(secondjob)) {
         return true;
      } else if (isAran(firstjob) && isAran(secondjob)) {
         return true;
      } else if (isMercedes(firstjob) && isMercedes(secondjob)) {
         return true;
      } else if (isEvan(firstjob) && isEvan(secondjob)) {
         return true;
      } else if (isPhantom(firstjob) && isPhantom(secondjob)) {
         return true;
      } else if (isEunWol(firstjob) && isEunWol(secondjob)) {
         return true;
      } else if (isLuminous(firstjob) && isLuminous(secondjob)) {
         return true;
      } else if (isBlaster(firstjob) && isBlaster(secondjob)) {
         return true;
      } else if (isMechanic(firstjob) && isMechanic(secondjob)) {
         return true;
      } else if (isBattleMage(firstjob) && isBattleMage(secondjob)) {
         return true;
      } else if (isWildHunter(firstjob) && isWildHunter(secondjob)) {
         return true;
      } else if (isDemonSlayer(firstjob) && isDemonSlayer(secondjob)) {
         return true;
      } else if (isDemonAvenger(firstjob) && isDemonAvenger(secondjob)) {
         return true;
      } else if (isXenon(firstjob) && isXenon(secondjob)) {
         return true;
      } else if (isMichael(firstjob) && isMichael(secondjob)) {
         return true;
      } else if (isKaiser(firstjob) && isKaiser(secondjob)) {
         return true;
      } else if (isCain(firstjob) && isCain(secondjob)) {
         return true;
      } else if (isKadena(firstjob) && isKadena(secondjob)) {
         return true;
      } else if (isAngelicBuster(firstjob) && isAngelicBuster(secondjob)) {
         return true;
      } else if (isZero(firstjob) && isZero(secondjob)) {
         return true;
      } else if (isKinesis(firstjob) && isKinesis(secondjob)) {
         return true;
      } else if (isIllium(firstjob) && isIllium(secondjob)) {
         return true;
      } else if (isArc(firstjob) && isArc(secondjob)) {
         return true;
      } else if (isAdel(firstjob) && isAdel(secondjob)) {
         return true;
      } else if (isHoyeong(firstjob) && isHoyeong(secondjob)) {
         return true;
      } else if (isLara(firstjob) && isLara(secondjob)) {
         return true;
      } else {
         return isKhali(firstjob) && isKhali(secondjob);
      }
   }
   ...
   public static int getLinkedSkill(int id) {
      ...
      case 400051079:
         return 400051078;
      default:
         return id == 155101204 ? 155101104 : id;
      }
   }
   ...
   public static int isRandStat(List<Pair<Integer, Integer>> list, int succ) {
      if (list.isEmpty()) {
         ...
         while(randomstat == 999) {
            ...
            Pair<Integer, Integer> test = (Pair)list.get(random);
            if (Randomizer.isSuccess((Integer)test.right, succ)) {
               randomstat = (Integer)test.left;
               break;
            }
         }
   ...
   public static boolean isChaosScroll(int itemId) {
      ...
      return ii.getName(itemId).contains("혼돈");
   }
   ...
   public static int getChaosNumber(int itemId) {
      ...
      if (ii.getName(itemId).contains("놀라운 긍정의")) {
         list.add(new Pair(0, 1838));
         list.add(new Pair(1, 3301));
         list.add(new Pair(2, 2387));
         list.add(new Pair(3, 1387));
         list.add(new Pair(4, 494));
         list.add(new Pair(6, 593));
      } else if (ii.getName(itemId).contains("놀라운")) {
         list.add(new Pair(-1, 137));
         list.add(new Pair(-2, 8));
         list.add(new Pair(-3, 365));
         list.add(new Pair(-4, 297));
         list.add(new Pair(-6, 494));
         list.add(new Pair(0, 1838));
         list.add(new Pair(1, 1931));
         list.add(new Pair(2, 1587));
         list.add(new Pair(3, 1021));
         list.add(new Pair(4, 198));
         list.add(new Pair(6, 99));
         ...
         list.add(new Pair(3, 1387));
         list.add(new Pair(4, 494));
         list.add(new Pair(2, 593));
      } else {
         if (!ii.getName(itemId).contains("혼돈의")) {
            return 999;
         }
   ...
   public static int getWeightedRandom(List<Pair<Integer, Integer>> weights) {
      ...
      Iterator var4 = weights.iterator();

      while(var4.hasNext()) {
         Pair<Integer, Integer> element = (Pair)var4.next();
         double a = (double)(Integer)element.getRight();
         double r = a / 10000.0D;
         double value = -Math.log(Randomizer.nextDouble()) / r;
         if (value < bestValue) {
            bestValue = value;
            potentialid = (Integer)element.getLeft();
         }
      }
   ...
   public static long getTaxAmount(long meso) {
      if (meso >= 100000000L) {
         return Math.round(0.06D * (double)meso);
      } else if (meso >= 25000000L) {
         return Math.round(0.05D * (double)meso);
      } else if (meso >= 10000000L) {
         return Math.round(0.04D * (double)meso);
      } else if (meso >= 5000000L) {
         return Math.round(0.03D * (double)meso);
      } else if (meso >= 1000000L) {
         return Math.round(0.018D * (double)meso);
      } else {
         return meso >= 100000L ? Math.round(0.008D * (double)meso) : 0L;
      }
   }

   public static int EntrustedStoreTax(long theQuantity) {
      if (theQuantity >= 100000000L) {
         return (int)Math.round(0.03D * (double)theQuantity);
      } else if (theQuantity >= 25000000L) {
         return (int)Math.round(0.025D * (double)theQuantity);
      } else if (theQuantity >= 10000000L) {
         return (int)Math.round(0.02D * (double)theQuantity);
      } else if (theQuantity >= 5000000L) {
         return (int)Math.round(0.015D * (double)theQuantity);
      } else if (theQuantity >= 1000000L) {
         return (int)Math.round(0.009D * (double)theQuantity);
      } else {
         return theQuantity >= 100000L ? (int)Math.round(0.004D * (double)theQuantity) : 0;
      }
   }
   ...
   public static int getSkillBook(int job, int level, int skill) {
      if (job >= 2210 && job <= 2218) {
         return job - 2209;
      } else if (!isSeparatedSp((short)job)) {
         return 0;
      } else {
   ...
   public static boolean isApplicableSkill_(int skil) {
      int[] var1 = PlayerStats.pvpSkills;
   ...
   public static int getJobNumber(int skill) {
      ...
      if (SkillFactory.getSkill(skill) != null && SkillFactory.getSkill(skill).isHyper()) {
         ...
         return 1;
      } else if (job / 100 != 0 && !isBeginnerJob(jobz)) {
   ...
   public static double getAttackRange(SecondaryStatEffect def, int rangeInc) {
      double defRange = (400.0D + (double)rangeInc) * (400.0D + (double)rangeInc);
      if (def != null) {
   ...
   public static double getAttackRange(Point lt, Point rb) {
      ...
      defRange += (double)(maxX * maxX + maxY * maxY);
   ...
   public static String getCurrentFullDate() {
      ...
      String var10000 = time.substring(0, 4);
      return var10000 + time.substring(5, 7) + time.substring(8, 10) + time.substring(11, 13) + time.substring(14, 16) + time.substring(17, 19);
   }

   public static int getCurrentDate() {
      String time = FileoutputUtil.CurrentReadable_Time();
      String var10000 = time.substring(0, 4);
      return Integer.parseInt(var10000 + time.substring(5, 7) + time.substring(8, 10) + time.substring(11, 13));
   }
   ...
   public static int getCurrentDateYesterday() {
      ...
      if (month < 10) {
         ...
         months = month.makeConcatWithConstants<invokedynamic>(month);
      }

      if (day < 10) {
         days = "0" + day;
      } else {
         days = day.makeConcatWithConstants<invokedynamic>(day);
      }
   ...
   public static int getCurrentDate_NoTime() {
      String time = FileoutputUtil.CurrentReadable_Time();
      String var10000 = time.substring(0, 4);
      return Integer.parseInt(var10000 + time.substring(5, 7) + time.substring(8, 10));
   }
   ...
   public static int getDiceStat(int buffid, int stat) {
      if (buffid != stat && buffid % 10 != stat && buffid / 10 != stat) {
         return buffid == stat * 100 ? getStatDice(stat) + 10 : 0;
      } else {
   ...
   public static long NeedAutSymbolMeso(int level) {
      long meso = (long)(99000000 + 88500000 * level);
      return meso;
   }
   ...
   public static int getCubeMeso(int itemId) {
      ...
      if (!ii.getEquipStats(itemId).containsKey("reqLevel")) {
         ...
         int level = (Integer)ii.getEquipStats(itemId).get("reqLevel");
         int meso = 0;
         switch(level) {
         case 35:
            meso = 612;
   ...
   public static long getMagnifyPrice(Equip eq) {
      ...
      if (!ii.getEquipStats(eq.getItemId()).containsKey("reqLevel")) {
         ...
         int level = (Integer)ii.getEquipStats(eq.getItemId()).get("reqLevel");
         int v1 = 0;
         if (level > 120) {
            v1 = 20;
         } else if (level > 70) {
         ...
         while(true) {
            ...
            if (v3 == 0) {
               ...
               long price = (long)((v1 * v5 <= 0 ? 1 : 0) - 1 & v1 * v5);
               return price;
            }
   ...
   public static int getAndroidType(int itemid) {
      return MapleItemInformationProvider.getInstance().getEquipStats(itemid).containsKey("android") ? (Integer)MapleItemInformationProvider.getInstance().getEquipStats(itemid).get("android") : 1;
   }
   ...
   public static boolean isThief(int job) {
      return isKhali(job) || isDefaultThief(job) || isHoyeong(job) || isNightLord(job) || isShadower(job) || isDualBlade(job) || isNightWalker(job) || isPhantom(job) || isKadena(job) || isXenon(job);
   }
   ...
   public static boolean is_keydown_skill(int a1) {
      ...
      if (a1 <= 33121009) {
         ...
         if (a1 == 80002780) {
            ...
            if (!v1) {
               return Integer.toUnsignedLong(a1 - 80001389) > 3L && !sub_815760(a1) ? isEncodeKeyDownSkill(a1) : true;
            } else {
               return true;
            }
         }
      } else if (a1 <= 400011028) {
         if (a1 == 400011028) {
            return true;
         } else if (a1 > 131001004) {
            if (a1 > 131001021) {
               v1 = a1 == 142111010;
            } else {
               if (a1 >= 131001020) {
         ...
         } else if (a1 >= 101110101 && a1 <= 101110102) {
            return true;
         } else {
            return Integer.toUnsignedLong(a1 - 80001389) > 3L && !sub_815760(a1) ? isEncodeKeyDownSkill(a1) : true;
         }
      ...
      if (a1 > 23120013) {
         ...
         if (a1 <= 14111023) {
            ...
            if (a1 >= 23101000) {
               ...
               return a1 == 23100004;
            } else if (a1 != 23001000 && a1 != 14120045) {
               if (a1 <= 14121000) {
                  return false;
               } else {
                  bool = a1 == 14121002;
   ...
   public static boolean sub_8242D0(int a1) {
      if (a1 <= 0) {
         return a1 - 90000000 >= 0 && a1 - 90000000 < 12;
      } else {
         int v1 = a1 / 10000;
         if (a1 / 10000 == 8000) {
            v1 = a1 / 100;
   ...
   public static boolean sub_6F5530(int a1) {
      ...
      } else if (a1 == 400021028) {
         return true;
      } else if (a1 > 152120003) {
         if (a1 <= 400021004) {
   ...
   public static int get_evan_job_level(int job) {
      int result = false;
      byte result;
      switch(job) {
      case 2200:
      ...
      if (a1 <= 15120003) {
         if (a1 == 15120003) {
            ...
            if (a1 <= 13121002) {
               if (a1 == 13121002) {
                  return 13120048;
               } else if (a1 != 12110028 && a1 - 12110028 != 9982) {
                  if (a1 - 12110028 == 9983) {
                     return 12120046;
                  } else {
                     if (sub_833A80(a1)) {
            ...
            if (a1 != 25121005) {
               if (a1 <= 21120006) {
                  if (a1 == 21120006) {
                     ...
                     return 15120048;
                  } else if (a1 != 21110020 && a1 != 21111021) {
                     if (sub_833A80(a1)) {
                        v1 = 3320030;
                     }
               ...
               } else if (a1 < 21121016 && a1 != 21120022) {
                  if (sub_833A80(a1)) {
                     v1 = 3320030;
                  }
   ...
   public static long getDreamBreakerHP(int stage) {
      if (stage < 10) {
         ...
         return stage == 201 ? 4700000000000L : Math.max(1L, 4700000000000L * (long)(stage - 201));
      }
   }
   ...
   public static void TangyoonCookingClass(MapleClient c, int number) {
      MapleCharacter chr = c.getPlayer();
      int ratio = 0;
      if (number == 0) {
         chr.setKeyValue(2498, "TangyoonCooking", Randomizer.rand(0, 4).makeConcatWithConstants<invokedynamic>(Randomizer.rand(0, 4)));
      }
      ...
      int rd1 = Randomizer.rand(0, 19);
      int rd2 = Randomizer.rand(0, 19);
      int rd3 = Randomizer.rand(0, 19);

      int rd4;
      for(rd4 = Randomizer.rand(0, 19); rd1 == rd2 || rd1 == rd3 || rd1 == rd4 || rd2 == rd3 || rd2 == rd4 || rd3 == rd4; rd4 = Randomizer.rand(0, 19)) {
      ...
      if (number < 5) {
         ...
         c.getSession().writeAndFlush(CField.UIPacket.openUIOption(122, (int)chr.getKeyValue(2498, "TangyoonCooking"), 0));
         c.getSession().writeAndFlush(CField.TangyoonMobList(mobList[0], mobList[1], mobList[2], mobList[3], mobList[4]));
      } else {
         c.getSession().writeAndFlush(CField.UIPacket.openUIOption(123, Randomizer.rand(0, 10), 0));
      }
   ...
   public static void TangyoonMob(MapleClient c, int mobid) {
      ...
      for(int i = 0; i < 10; ++i) {
         int a = Randomizer.rand(220, 1500);
   ...
   public static void TangyoonMobSpawn(final MapleClient c, final int mobid, final boolean cancel) {
      if (cancel) {
         c.getPlayer().getMap().resetFully();
      }

      tangyoonloop = 0;
      final Timer tangTimer = new Timer();
      TimerTask tangTask = new TimerTask() {
         public void run() {
            if (!cancel && c.getPlayer().getMapId() == 912080100) {
               if (GameConstants.tangyoonloop < 9) {
                  GameConstants.TangyoonMob(c, mobid);
                  ++GameConstants.tangyoonloop;
               } else {
                  GameConstants.TangYoonMobDelete(c, mobid, false, false, false);
                  tangTimer.cancel();
               }

            } else {
               tangTimer.cancel();
               GameConstants.TangYoonMobDelete(c, mobid, true, false, false);
            }
         }
      };
      tangTimer.schedule(tangTask, 1L, 8000L);
   }

   public static void TangYoonMobDelete(final MapleClient c, final int mobid, final boolean cancel, final boolean fire, final boolean boss) {
      final Timer tangTimer = new Timer();
      TimerTask tangTask = new TimerTask() {
         public void run() {
            if (!cancel && c.getPlayer().getMapId() == 912080100) {
               if (c.getPlayer().getMap().getNumMonsters() <= 0 && !fire && !boss) {
                  GameConstants.TangyoonCookingClass(c, (int)c.getPlayer().getKeyValue(2498, "TangyoonCookingClass"));
                  tangTimer.cancel();
      ...
      tangTimer.schedule(tangTask, 1L, 500L);
   }
         ...
         do {
            ...
            case 33:
               ...
               while(true) {
                  ...
                  ret.attackObjects.add(new Pair(lea.readInt(), lea.readInt()));
                  ++i;
               }
            case 36:
               x = lea.readByte();
   ...
   public static void sendFireOption(MaplePacketLittleEndianWriter mplew, long newRebirth, Equip equip) {
      ...
      Iterator var13 = zz.entrySet().iterator();

      while(var13.hasNext()) {
         Entry<Integer, Integer> z = (Entry)var13.next();
         mplew.writeInt((Integer)z.getKey() == 22 ? 12 : (Integer)z.getKey());
         mplew.writeInt((Integer)z.getKey() == 22 ? -(Integer)z.getValue() : (Integer)z.getValue());
      }
   ...
   public static void fireValue(int randomOption, int reqLevel, int randomValue, int ordinaryPad, int ordinaryMad, int itemId, Map<Integer, Integer> zz) {
      ...
      case 3:
         if (zz.containsKey(randomOption)) {
            zz.put(randomOption, (Integer)zz.get(randomOption) + (reqLevel / 20 + 1) * randomValue);
         } else {
      ...
      case 4:
         if (zz.containsKey(0)) {
            zz.put(0, (Integer)zz.get(0) + (reqLevel / 40 + 1) * randomValue);
         } else {
            zz.put(0, (reqLevel / 40 + 1) * randomValue);
         }

         if (zz.containsKey(1)) {
            zz.put(1, (Integer)zz.get(1) + (reqLevel / 40 + 1) * randomValue);
         } else {
      ...
      case 5:
         ...
         if (zz.containsKey(2)) {
            zz.put(2, (Integer)zz.get(2) + (reqLevel / 40 + 1) * randomValue);
         } else {
      ...
      case 6:
         ...
         if (zz.containsKey(3)) {
            zz.put(3, (Integer)zz.get(3) + (reqLevel / 40 + 1) * randomValue);
         } else {
   ...
   public static List<MatrixSkill> matrixSkills(LittleEndianAccessor slea) {
      ...
      ArrayList<MatrixSkill> skills = new ArrayList();
   ...
   public static boolean is_forceAtom_attack_skill(int a1) {
      ...
      if (!v2 && a1 != 4100012 && a1 != 4120019 && a1 != 35101002 && a1 != 35110017 && !sub_84ABA0(a1) && !sub_884580(a1) && !sub_5B9DA0(a1) && Integer.toUnsignedLong(a1 - 80002602) > 19L && !sub_86B470(a1)) {
         ...
         } else if (a1 <= 400031031) {
            if (a1 == 400031031) {
               return true;
            } else if (a1 <= 400031000) {
   ...
   public static double getJobInt(int jobid) {
      if (!isFPMage(jobid) && !isBishop(jobid) && !isILMage(jobid) && !isFlameWizard(jobid)) {
         if (isXenon(jobid)) {
            return 0.875D;
         } else {
            return isHero(jobid) ? 1.08D : 1.0D;
         }
      } else {
         return 1.2D;
      }
   ...
   public static boolean getPotentialCheck(int potentialid1, int potentialid2, int potentialid3) {
      if ((potentialid1 == 30601 || potentialid1 == 30055 || potentialid1 == 40043 || potentialid1 == 40601 || potentialid1 == 40602 || potentialid1 == 40603) && (potentialid2 == 30601 || potentialid2 == 30055 || potentialid2 == 40043 || potentialid2 == 40601 || potentialid2 == 40602 || potentialid2 == 40603) && (potentialid3 == 30601 || potentialid3 == 30055 || potentialid3 == 40043 || potentialid3 == 40601 || potentialid3 == 40602 || potentialid3 == 40603)) {
         return false;
      } else if (potentialid1 != 10291 && potentialid1 != 30291 && potentialid1 != 40291 && potentialid1 != 40292 || potentialid2 != 10291 && potentialid2 != 30291 && potentialid2 != 40291 && potentialid2 != 40292 || potentialid3 != 10291 && potentialid3 != 30291 && potentialid3 != 40291 && potentialid3 != 40292) {
   ...
   public static int UnionMaxCoin(MapleCharacter chr) {
      ...
      if (union >= 101 && union <= 105) {
         return 200;
      } else if (union >= 201 && union <= 205) {
         return 300;
      } else if (union >= 301 && union <= 305) {
         return 500;
      } else {
         return union >= 401 && union <= 405 ? 700 : 0;
      }
   }
   ...
   public static boolean 사출기(int skill) {
      switch(skill) {
      case 3100010:
      case 3101009:
      case 3101012:
   ...
   public static int blessSkillJob(int job) {
      if (job >= 0 && job <= 910) {
         return 0;
      } else if (job >= 1000 && job <= 1512) {
         return 10000000;
      } else if (job >= 3000 && job <= 3512) {
         return 30000000;
      } else if (isKaiser(job)) {
         return 60000000;
      } else if (isLara(job)) {
   ...
   static {
      rangedMapobjectTypes = Collections.unmodifiableList(Arrays.asList(MapleMapObjectType.ITEM, MapleMapObjectType.MONSTER, MapleMapObjectType.DOOR, MapleMapObjectType.REACTOR, MapleMapObjectType.SUMMON, MapleMapObjectType.NPC, MapleMapObjectType.MIST, MapleMapObjectType.EXTRACTOR));
      exp = new long[1000];
      exp2 = new long[20];
      ...
      cumulativeTraitExp = new int[]{0, 20, 46, 80, 124, 181, 255, 351, 476, 639, 851, 1084, 1340, 1622, 1932, 2273, 2648, 3061, 3515, 4014, 4563, 5128, 5710, 6309, 6926, 7562, 8217, 8892, 9587, 10303, 11040, 11788, 12547, 13307, 14089, 14883, 15689, 16507, 17337, 18179, 19034, 19902, 20783, 21677, 22584, 23505, 24440, 25399, 26362, 27339, 28331, 29338, 30360, 31397, 32450, 33519, 34604, 35705, 36823, 37958, 39110, 40279, 41466, 32671, 43894, 45135, 46395, 47674, 48972, 50289, 51626, 52967, 54312, 55661, 57014, 58371, 59732, 61097, 62466, 63839, 65216, 66597, 67982, 69371, 70764, 72161, 73562, 74967, 76376, 77789, 79206, 80627, 82052, 83481, 84914, 86351, 87792, 89237, 90686, 92139, 93596, 96000};
      ...
      guildexp = new int[]{0, 15000, 60000, 135000, 240000, 375000, 540000, 735000, 960000, 1215000, 1500000, 1815000, 2160000, 2535000, 2940000, 3375000, 3840000, 4335000, 4860000, 5415000, 6000000, 6615000, 7260000, 7935000, 8640000, 12528000, 18165600, 26340120, 38193170, 68747700};
      ...
      itemBlock = new int[0];
      cashBlock = new Integer[0];
      blockedSkills = new int[]{4341003};
      RESERVED = new String[]{"Rental", "Donor", "MapleNews"};
      dList = new ArrayList();
      stats = new String[]{"tuc", "reqLevel", "reqJob", "reqSTR", "reqDEX", "reqINT", "reqLUK", "reqPOP", "cash", "cursed", "success", "setItemID", "equipTradeBlock", "durability", "randOption", "randStat", "masterLevel", "reqSkillLevel", "elemDefault", "incRMAS", "incRMAF", "incRMAI", "incRMAL", "canLevel", "skill", "charmEXP", "bdR", "imdR", "onlyEquip", "jokerToSetItem", "android", "attackSpeed"};
      hyperTele = new int[]{310000000, 220000000, 100000000, 250000000, 240000000, 104000000, 103000000, 102000000, 101000000, 120000000, 260000000, 200000000, 230000000};
      rankC = new int[]{70000000, 70000001, 70000002, 70000003, 70000004, 70000005, 70000006, 70000007, 70000008, 70000009, 70000010, 70000011, 70000012, 70000013};
      rankB = new int[]{70000014, 70000015, 70000016, 70000017, 70000018, 70000021, 70000022, 70000023, 70000024, 70000025, 70000026};
      rankA = new int[]{70000027, 70000028, 70000029, 70000030, 70000031, 70000032, 70000033, 70000034, 70000035, 70000036, 70000039, 70000040, 70000041, 70000042};
      rankS = new int[]{70000043, 70000044, 70000045, 70000047, 70000048, 70000049, 70000050, 70000051, 70000052, 70000053, 70000054, 70000055, 70000056, 70000057, 70000058, 70000059, 70000060, 70000061, 70000062};
      showEffectDropItems = new int[]{1022231, 1012478, 1132296, 1113149, 1032241, 1122000, 1122076, 1022232, 1132272, 1162025, 1122254, 1122150, 1162009, 1032136, 1152170, 1182087, 1113282, 1022277, 1672076, 1012632, 1022278, 1132308, 1162080, 1162082, 1162081, 1162083, 1122430, 1182285};
      StarInfo = new int[][]{{20, 30, 50}, {20, 30, 50}, {20, 30, 50}, {10, 30, 50}, {20, 60, 100}, {15, 45, 75}, {30, 90, 180}, {15, 45, 75}, {20, 60, 100}, {35, 105, 175}, {30, 90, 150}, {20, 60, 100}, {25, 75, 125}, {15, 45, 75}, {15, 45, 75}, {20, 60, 100}, {20, 60, 100}, {120, 200, 300}, {40, 120, 200}, {50, 150, 250}, {30, 90, 150}, {30, 90, 150}, {30, 90, 150}, {30, 90, 150}, {40, 120, 200}, {40, 120, 200}, {60, 180, 300}, {60, 180, 300}, {35, 105, 175}, {30, 90, 150}, {30, 90, 150}, {15, 45, 75}, {60, 180, 300}, {15, 45, 75}, {60, 180, 300}, {40, 120, 200}, {40, 120, 200}, {45, 135, 225}, {35, 105, 175}, {540, 570, 600}};
      questReader = new ArrayList();
      price = new HashMap();
      dailyItems = new ArrayList();
      chariotItems = new ArrayList();
      chariotItems.add(new Triple(9, 5062503, 300));
      chariotItems.add(new Triple(18, 2430007, 2));
      chariotItems.add(new Triple(27, 4310016, 10));
      chariotItems.add(new Triple(36, 2048717, 100));
      chariotItems.add(new Triple(45, 2048753, 50));
      chariotItems.add(new Triple(54, 5069001, 10));
      chariotItems.add(new Triple(63, 5068301, 2));
      chariotItems.add(new Triple(72, 5069100, 2));
      chariotItems.add(new Triple(81, 2049360, 3));
      chariotItems.add(new Triple(90, 2049136, 7));
      chariotItems.add(new Triple(99, 5060048, 5));
      chariotItems.add(new Triple(108, 2049376, 1));
      chariotItems.add(new Triple(117, 5062005, 15));
      chariotItems.add(new Triple(126, 5062006, 10));
      dList.add(new Pair("mirrorD_321_0_", ""));
      dList.add(new Pair("mirrorD_321_1_", ""));
      dList.add(new Pair("mirrorD_321_2_", ""));
      dList.add(new Pair("mirrorD_321_3_", ""));
      dList.add(new Pair("mirrorD_322_0_", ""));
      ...
      price.put(8500022, 1150);
      price.put(8950102, 1275);
      price.put(8880111, 1300);
      price.put(8880156, 1325);
      price.put(8880167, 1425);
      price.put(8880342, 1525);
      price.put(8644650, 1575);
      price.put(8880101, 1875);
      price.put(8950002, 1925);
      price.put(8880177, 2000);
      price.put(8880302, 2100);
      price.put(8644655, 2150);
      price.put(8645066, 2200);
      price.put(8880405, 2350);
      price.put(8880504, 6000);
      price.put(8880614, 8000);
      exp2[0] = 15L;
      exp2[1] = 34L;
      exp2[2] = 57L;
      exp2[3] = 92L;
      ...
      for(a = 15; a < 30; ++a) {
         if (a == 15) {
            exp[15] = (long)Math.floor((double)exp[14] * 1.2D);
         } else {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.2D);
         }
      }
      ...
      for(a = 35; a < 40; ++a) {
         if (a == 35) {
            exp[35] = (long)Math.floor((double)exp[34] * 1.2D);
         } else {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.2D);
         }
      }
      ...
      for(a = 40; a < 60; ++a) {
         if (a == 40) {
            exp[40] = (long)Math.floor((double)exp[39] * 1.08D);
         } else {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.08D);
         }
      }
      ...
      for(a = 65; a < 75; ++a) {
         if (a == 65) {
            exp[65] = (long)Math.floor((double)exp[64] * 1.075D);
         } else {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.075D);
         }
      }

      for(a = 75; a < 90; ++a) {
         if (a == 75) {
            exp[75] = (long)Math.floor((double)exp[74] * 1.07D);
         } else {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.07D);
         }
      }

      for(a = 90; a < 100; ++a) {
         if (a == 90) {
            exp[90] = (long)Math.floor((double)exp[89] * 1.065D);
         } else {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.065D);
         }
      }
      ...
      for(a = 105; a < 140; ++a) {
         if (a == 105) {
            exp[105] = (long)Math.floor((double)exp[104] * 1.065D);
         } else {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.065D);
         }
      }
      ...
      for(a = 140; a < 170; ++a) {
         if (a == 140) {
            exp[140] = (long)Math.floor((double)exp[139] * 1.0625D);
         } else {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.0625D);
         }
      }

      for(a = 170; a < 200; ++a) {
         if (a == 170) {
            exp[170] = (long)Math.floor((double)exp[169] * 1.05D);
         } else {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.05D);
         }
      }

      for(a = 200; a < 210; ++a) {
         if (a != 200 && a != 201) {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.12D);
         } else {
            exp[200] = 2207026470L;
            exp[201] = (long)Math.floor((double)exp[200] * 1.12D);
         }
      }

      for(a = 210; a < 215; ++a) {
         if (a != 210 && a != 211) {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.11D);
         } else {
            exp[210] = (long)Math.floor((double)exp[209] * 1.6D);
            exp[211] = (long)Math.floor((double)exp[210] * 1.11D);
         }
      }

      for(a = 215; a < 220; ++a) {
         if (a != 215 && a != 211) {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.09D);
         } else {
            exp[215] = (long)Math.floor((double)exp[214] * 1.3D);
            exp[211] = (long)Math.floor((double)exp[210] * 1.09D);
         }
      }
      ...
      for(a = 220; a < 225; ++a) {
         if (a != 220 && a != 221) {
            ...
            exp[221] = (long)Math.floor((double)exp[220] * 1.07D);
         }
      }
      ...
      for(a = 225; a < 230; ++a) {
         if (a != 225 && a != 226) {
            ...
            exp[225] = (long)Math.floor((double)exp[224] * 1.3D);
            exp[226] = (long)Math.floor((double)exp[225] * 1.05D);
         }
      }

      for(a = 230; a < 235; ++a) {
         if (a == 230) {
            exp[230] = (long)Math.floor((double)exp[229] * 1.6D);
         } else {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.03D);
         }
      }

      for(a = 235; a < 240; ++a) {
         if (a == 235) {
            exp[235] = (long)Math.floor((double)exp[234] * 1.3D);
         } else {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.03D);
         }
      }
      ...
      for(a = 240; a < 245; ++a) {
         if (a == 240) {
            exp[240] = (long)Math.floor((double)exp[239] * 1.6D);
         } else {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.03D);
         }
      }
      ...
      for(a = 245; a < 250; ++a) {
         if (a == 245) {
            exp[245] = (long)Math.floor((double)exp[244] * 1.3D);
         } else {
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.03D);
         }
      }
      ...
      for(a = 260; a < 275; ++a) {
         if (a == 260) {
            ...
            exp[a] = (long)Math.floor((double)exp[a - 1] * 1.01D);
         }
      }
