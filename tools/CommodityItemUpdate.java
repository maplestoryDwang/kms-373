...
public class CommodityItemUpdate {
   public static void main(String[] args) throws FileNotFoundException, IOException {
      ...
      int[] sn = new int[]{140000325, 140100697, 140200206, 140300460, 140400285, 140500217, 140600236, 140700065, 140800232, 140900087, 141000086, 160000237, 160100268};
      int idx = false;
      int id = 0;
      Iterator var6 = MapleItemInformationProvider.getInstance().getAllItems().iterator();

      while(var6.hasNext()) {
         Pair<Integer, String> item = (Pair)var6.next();
         int itemid = (Integer)item.left;
         boolean containsRoyal = false;
         int[] var10 = royalStyle;
         int var11 = royalStyle.length;
         ...
         if (!containsRoyal) {
            ...
            if (idx != -1 && MapleItemInformationProvider.getInstance().isCash(itemid)) {
