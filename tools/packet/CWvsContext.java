...
import handling.world.guild.MapleGuildType;
...
public class CWvsContext {
   ...
   public static byte[] updatePlayerStats(Map<MapleStat, Long> mystats, boolean itemReaction, boolean itemReaction2, MapleCharacter chr, boolean isPet) {
      MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
      ...
      Iterator var9;
      MapleStat statupdate;
      for(var9 = mystats.keySet().iterator(); var9.hasNext(); updateMask |= statupdate.getValue()) {
         statupdate = (MapleStat)var9.next();
      }

      mplew.writeInt(updateMask);
      var9 = mystats.entrySet().iterator();

      while(true) {
         label62:
         while(var9.hasNext()) {
            Entry<MapleStat, Long> statupdate = (Entry)var9.next();
            switch((MapleStat)statupdate.getKey()) {
            case SKIN:
            case BATTLE_RANK:
            case ICE_GAGE:
               mplew.write(((Long)statupdate.getValue()).byteValue());
               break;
            case JOB:
               mplew.writeShort(((Long)statupdate.getValue()).shortValue());
            ...
            case AVAILABLESP:
               if (GameConstants.isSeparatedSp(chr.getJob())) {
                  ...
                  while(true) {
                     if (i >= chr.getRemainingSps().length) {
                        continue label62;
                     }
               ...
               break;
            case TRAIT_LIMIT:
               MapleTrait.MapleTraitType[] var11 = MapleTrait.MapleTraitType.values();
               int var12 = var11.length;

               for(int var13 = 0; var13 < var12; ++var13) {
                  MapleTrait.MapleTraitType t = var11[var13];
            ...
            case EXP:
            case MESO:
               mplew.writeLong((Long)statupdate.getValue());
               break;
            case PET:
               mplew.writeLong((long)((Long)statupdate.getValue()).intValue());
               mplew.writeLong((long)((Long)statupdate.getValue()).intValue());
               mplew.writeLong((long)((Long)statupdate.getValue()).intValue());
               break;
            case BATTLE_POINTS:
            ...
            case RECOVERY_POTION_WITH_MP:
               mplew.writeInt(((Long)statupdate.getValue()).intValue());
               mplew.writeLong(0L);
               mplew.writeLong(0L);
               mplew.writeLong(0L);
               mplew.write((int)0);
   ...
   public static byte[] temporaryStats(Map<MapleStat.Temp, Integer> mystats) {
      ...
      for(var3 = mystats.keySet().iterator(); var3.hasNext(); updateMask |= statupdate.getValue()) {
         statupdate = (MapleStat.Temp)var3.next();
      }

      mplew.writeInt(updateMask);
      var3 = mystats.entrySet().iterator();

      while(var3.hasNext()) {
         Entry<MapleStat.Temp, Integer> statupdate = (Entry)var3.next();
   ...
   public static byte[] updateSkills(Map<Skill, SkillEntry> update) {
      ...
      Iterator var2 = update.entrySet().iterator();

      while(var2.hasNext()) {
         Entry<Skill, SkillEntry> z = (Entry)var2.next();
   ...
   public static void DamageSkinInfo(MapleCharacter chr, MaplePacketLittleEndianWriter mplew) {
      ...
      mplew.write((int)0);
      String var10001 = MapleItemInformationProvider.getInstance().getName(skinid);
      mplew.writeMapleAsciiString(var10001 + "이다.\\r\\n\\r\\n\\r\\n\\r\\n\\r\\n");
      mplew.writeInt(0);
      mplew.writeInt(-1);
      mplew.writeInt(0);
      mplew.write((int)1);
      ...
      for(int i = 0; i < skinsize; ++i) {
         int skin = (int)chr.getKeyValue(13191, i.makeConcatWithConstants<invokedynamic>(i));
         mplew.writeInt(skin);
   ...
   public static byte[] charInfo(MapleCharacter chr, boolean isSelf) {
      ...
      if (chr.getMarriageId() <= 0) {
         ...
         if (data != null && data.getStatus() >= 1) {
            if (data.getStatus() >= 2) {
               mplew.write((int)1);
               MapleRing ring = (MapleRing)((List)chr.getRings(true).getRight()).listIterator().next();
               if (ring == null) {
      ...
      mplew.writeInt(dojo);
      mplew.writeMapleAsciiString("");
      mplew.writeInt(chr.getAllUnion());
      ...
      int petindex = 0;
      int position = 114;
      MaplePet[] var10 = chr.getPets();
      int var11 = var10.length;

      for(int var12 = 0; var12 < var11; ++var12) {
         MaplePet pet = var10[var12];
         if (pet != null) {
            if (petindex >= 1) {
      ...
      Iterator var22 = medalQuests.iterator();

      while(var22.hasNext()) {
         Pair<Integer, Long> x = (Pair)var22.next();
         mplew.writeInt((Integer)x.left);
         mplew.writeLong((Long)x.right);
      }

      DamageSkinInfo(chr, mplew);
      MapleTrait.MapleTraitType[] var23 = MapleTrait.MapleTraitType.values();
      int var25 = var23.length;

      for(int var14 = 0; var14 < var25; ++var14) {
         MapleTrait.MapleTraitType t = var23[var14];
   ...
   public static byte[] serverMessage(int type, int channel, String name, String message, boolean megaEar) {
      return serverMessage(type, channel, name, message, megaEar, (Item)null);
   }
   ...
   public static byte[] tripleSmega(String name, List<String> message, boolean ear, int channel) {
      ...
      PacketHelper.ChatPacket(mplew, name, (String)message.get(0));
      mplew.write(message.size());

      for(int i = 1; i < message.size(); ++i) {
         if (message.get(i) != null) {
            mplew.writeMapleAsciiString((String)message.get(i));
            PacketHelper.ChatPacket(mplew, name, (String)message.get(i));
         }
      }
   ...
   public static byte[] getOwlOpen() {
      ...
      int[] var1 = GameConstants.owlItems;
   ...
   public static byte[] updateHyperPresets(MapleCharacter chr, int pos, byte action) {
      ...
      if (action != 0) {
         for(int i = 0; i <= 2; ++i) {
            ...
            Iterator var5 = chr.loadHyperStats(i).iterator();

            while(var5.hasNext()) {
               MapleHyperStats mhsz = (MapleHyperStats)var5.next();
   ...
   public static byte[] PsychicGrab(int cid, int skillid, int unk, int id, Map<Integer, List<PsychicGrabEntry>> grab) {
      ...
      for(int i = 1; i <= grab.size(); ++i) {
         Iterator var7 = ((List)grab.get(i)).iterator();

         while(var7.hasNext()) {
            PsychicGrabEntry pg = (PsychicGrabEntry)var7.next();
   ...
   public static byte[] PsychicGrabAttack(int cid, int skillid, int subskillid, int unk, int id, byte a, int b, List<Integer> grab) {
      ...
      Iterator var9 = grab.iterator();

      while(var9.hasNext()) {
         Integer g = (Integer)var9.next();
         mplew.writeInt(g);
      }
   ...
   public static byte[] PsychicGrabPreparation(MapleCharacter chr, int skillid, short level, int unk, int speed, int[] unk2, int[] mob, short[] unk3, byte[] unk4, Point[] pos1, Point[] pos2, Point[] pos3, Point[] pos4, Point[] pos5) {
      ...
      for(int i = 0; i < k; ++i) {
         ...
         mplew.writeLong(mob[i] != 0 ? (long)((int)target.getHp()) : 100L);
         mplew.writeLong(mob[i] != 0 ? (long)((int)target.getHp()) : 100L);
         mplew.write(unk4[i]);
   ...
   public static byte[] MatrixSkill(int skillid, int level, List<MatrixSkill> skills) {
      ...
      while(var4.hasNext()) {
         MatrixSkill skill = (MatrixSkill)var4.next();
   ...
   public static byte[] MatrixSkillMulti(MapleCharacter chr, int skillid, int level, int unk1, int unk2, int bullet, boolean data, List<Integer> datas, List<MatrixSkill> skills, byte dir) {
      ...
      mplew.write(data);
      if (data) {
         mplew.writeInt((Integer)datas.get(0));
         mplew.writeInt((Integer)datas.get(1));
         mplew.writeInt((Integer)datas.get(2));
         mplew.writeInt((Integer)datas.get(3));
         mplew.writeInt((Integer)datas.get(4));
         mplew.write((Integer)datas.get(5));
         mplew.writeInt((Integer)datas.get(6));
         mplew.write((Integer)datas.get(7));
      }
      ...
      default:
         ...
         while(var11.hasNext()) {
            MatrixSkill skill = (MatrixSkill)var11.next();
   ...
   public static byte[] Unlocklinkskill(int oriskillid, Map<Integer, Integer> unlock) {
      ...
      Iterator var3 = unlock.entrySet().iterator();

      while(var3.hasNext()) {
         Entry<Integer, Integer> skill = (Entry)var3.next();
         mplew.writeInt((Integer)skill.getKey());
         mplew.writeInt((Integer)skill.getValue());
      }
   ...
   public static byte[] setBossReward(MapleCharacter player) {
      ...
      for(int i = 0; i < items.size(); ++i) {
         mplew.writeLong((long)((Item)items.get(i)).getReward().getObjectId());
         ...
         mplew.writeInt(0);
         mplew.writeLong(0L);
         mplew.writeLong(PacketHelper.getKoreanTimestamp(((Item)items.get(i)).getExpiration() - 604800000L));
      }
   ...
   public static byte[] setUnion(MapleClient c) {
      ...
      long preset = (long)Integer.parseInt(c.getKeyValue("presetNo"));
      List<MapleUnion> equipped = new ArrayList();
      Iterator var5 = c.getPlayer().getUnions().getUnions().iterator();

      MapleUnion chr;
      while(var5.hasNext()) {
         chr = (MapleUnion)var5.next();
         if (chr.getPosition() >= 0) {
            equipped.add(chr);
         }
      }
      ...
      var5 = c.getPlayer().getUnions().getUnions().iterator();
   ...
   public static byte[] unionFreeset(MapleClient c, int presetNum) {
      ...
      List<MapleUnion> equipped = new ArrayList();
      Iterator var4 = c.getPlayer().getUnions().getUnions().iterator();

      while(true) {
         MapleUnion union;
         while(var4.hasNext()) {
            union = (MapleUnion)var4.next();
            if (presetNum == 0 && union.getPriset() > 0) {
               equipped.add(union);
            } else if (presetNum == 1 && union.getPriset1() > 0) {
               equipped.add(union);
            } else if (presetNum == 2 && union.getPriset2() > 0) {
               equipped.add(union);
            } else if (presetNum == 3 && union.getPriset3() > 0) {
               equipped.add(union);
            } else if (presetNum == 4 && union.getPriset4() > 0) {
               equipped.add(union);
            }
         }
         ...
         for(int i = 0; i < 8; ++i) {
            mplew.writeInt(c.getCustomData(500627 + presetNum, i.makeConcatWithConstants<invokedynamic>(i)) == null ? i : Integer.parseInt(c.getCustomData(500627 + presetNum, i.makeConcatWithConstants<invokedynamic>(i))));
         }

         mplew.writeInt(equipped.size());
         var4 = equipped.iterator();

         while(var4.hasNext()) {
            union = (MapleUnion)var4.next();
            mplew.writeInt(1);
            mplew.writeInt(union.getCharid());
            mplew.writeInt(union.getLevel());
            mplew.writeInt(union.getJob());
            mplew.writeInt(union.getUnk1());
            mplew.writeInt(presetNum == 4 ? union.getPos4() : (presetNum == 3 ? union.getPos3() : (presetNum == 2 ? union.getPos2() : (presetNum == 1 ? union.getPos1() : union.getPos()))));
            mplew.writeInt(presetNum == 4 ? union.getPriset4() : (presetNum == 3 ? union.getPriset3() : (presetNum == 2 ? union.getPriset2() : (presetNum == 1 ? union.getPriset1() : union.getPriset()))));
            mplew.writeInt(union.getUnk3());
   ...
   public static byte[] equipmentEnchantResult(int op, Equip item, Equip item2, EquipmentScroll scroll, StarForceStats stats, int... args) {
      ...
      case 50:
         ...
         List<EquipmentScroll> ess = EquipmentEnchant.equipmentScrolls(item);
         mplew.write(ess.size());
         Iterator var12 = ess.iterator();

         while(var12.hasNext()) {
            EquipmentScroll es = (EquipmentScroll)var12.next();
            ...
            mplew.writeInt(es.getName().contains("아크") ? 4 : (!es.getName().contains("이노센트") && !es.getName().contains("순백") ? 0 : 1));
      ...
      case 52:
         ...
         long meso = (long)((double)args[3] * rate);
         if (meso < 0L) {
            meso &= 4294967295L;
         }
         ...
         mplew.writeLong(0L);
         mplew.writeLong(ServerConstants.starForceSalePercent > 0 ? (long)args[3] : 0L);
         mplew.write((int)0);
         mplew.write((int)0);
         ...
         mplew.writeInt(0);
         mplew.writeInt(0);
         mplew.write(item.getEnchantBuff() & 32);
         mplew.writeInt(stats.getFlag());
         if (EnchantFlag.Watk.check(stats.getFlag())) {
            mplew.writeInt((Integer)stats.getFlag(EnchantFlag.Watk).right);
         }

         if (EnchantFlag.Matk.check(stats.getFlag())) {
            mplew.writeInt((Integer)stats.getFlag(EnchantFlag.Matk).right);
         }

         if (EnchantFlag.Str.check(stats.getFlag())) {
            mplew.writeInt((Integer)stats.getFlag(EnchantFlag.Str).right);
         }

         if (EnchantFlag.Dex.check(stats.getFlag())) {
            mplew.writeInt((Integer)stats.getFlag(EnchantFlag.Dex).right);
         }

         if (EnchantFlag.Int.check(stats.getFlag())) {
            mplew.writeInt((Integer)stats.getFlag(EnchantFlag.Int).right);
         }

         if (EnchantFlag.Luk.check(stats.getFlag())) {
            mplew.writeInt((Integer)stats.getFlag(EnchantFlag.Luk).right);
         }

         if (EnchantFlag.Wdef.check(stats.getFlag())) {
            mplew.writeInt((Integer)stats.getFlag(EnchantFlag.Wdef).right);
         }

         if (EnchantFlag.Mdef.check(stats.getFlag())) {
            mplew.writeInt((Integer)stats.getFlag(EnchantFlag.Mdef).right);
         }

         if (EnchantFlag.Hp.check(stats.getFlag())) {
            mplew.writeInt((Integer)stats.getFlag(EnchantFlag.Hp).right);
         }

         if (EnchantFlag.Mp.check(stats.getFlag())) {
            mplew.writeInt((Integer)stats.getFlag(EnchantFlag.Mp).right);
         }

         if (EnchantFlag.Acc.check(stats.getFlag())) {
            mplew.writeInt((Integer)stats.getFlag(EnchantFlag.Avoid).right);
         }
   ...
   public static byte[] blizzardTempest(List<Pair<Integer, Integer>> lists) {
      ...
      while(var2.hasNext()) {
         Pair<Integer, Integer> list = (Pair)var2.next();
   ...
   public static class BuddylistPacket {
      public static byte[] updateBuddylist(Collection<BuddylistEntry> buddylist, BuddylistEntry buddies, byte op) {
         ...
         if (op == 21) {
            ...
            Iterator var4 = buddylist.iterator();

            while(var4.hasNext()) {
               BuddylistEntry buddy = (BuddylistEntry)var4.next();
               mplew.writeInt(buddy.getCharacterId());
               mplew.writeAsciiString(buddy.getName(), 13);
               mplew.write((int)5);
               mplew.writeInt(buddy.getChannel() == -1 ? -1 : buddy.getChannel() - 1);
               mplew.writeAsciiString(buddy.getGroupName(), 18);
               mplew.writeInt(buddy.getAccountId());
               mplew.writeAsciiString(buddy.getRepName(), 13);
               mplew.writeAsciiString(buddy.getMemo(), 260);
            }
         } else if (op == 23) {
   ...
   public static class PartyPacket {
      ...
      public static void addPartyStatus(MapleCharacter chr, int forchannel, MapleParty party, MaplePacketLittleEndianWriter mplew, boolean leaving, boolean exped, byte type) {
         ...
         Iterator var8 = partymembers.iterator();
            ...
            do {
               if (!var8.hasNext()) {
                  if (type > 0) {
                     ...
                     mplew.writeInt(0);
                     var8 = partymembers.iterator();

                     while(var8.hasNext()) {
                        partychar = (MaplePartyCharacter)var8.next();
               ...
               partychar = (MaplePartyCharacter)var8.next();
            } while(type == 3 && partychar.getId() == chr.getPlayer().getId());
      ...
      public static byte[] showMemberSearch(List<MapleCharacter> chr) {
         ...
         Iterator var2 = chr.iterator();

         while(var2.hasNext()) {
            MapleCharacter c = (MapleCharacter)var2.next();
            mplew.writeInt(c.getId());
            mplew.writeMapleAsciiString(c.getName());
            mplew.writeShort(c.getJob());
            mplew.write((int)c.getLevel());
         }
      ...
      public static byte[] showPartySearch(List<MapleParty> chr) {
         ...
         while(var2.hasNext()) {
            MapleParty c = (MapleParty)var2.next();
            mplew.writeInt(c.getId());
            ...
            while(var4.hasNext()) {
               MaplePartyCharacter ch = (MaplePartyCharacter)var4.next();
   ...
   public static class GuildPacket {
      ...
      public static void getGuildInfo(MaplePacketLittleEndianWriter mplew, MapleGuild guild) {
         ...
         for(size = 1; size <= 10; ++size) {
            mplew.writeMapleAsciiString(size > 5 ? "" : guild.getRankTitle(size));
            mplew.writeInt(size > 5 ? 1024 : guild.getRankRole(size));
         }
         ...
         Iterator var4 = guild.getSkills().iterator();

         while(var4.hasNext()) {
            MapleGuildSkill mapleGuildSkill = (MapleGuildSkill)var4.next();
         ...
         mplew.write(false);
         mplew.write((int)-1);
         size = guild.getCustomEmblem() == null ? 0 : guild.getCustomEmblem().length;
         mplew.writeInt(size);
         if (size > 0) {
      ...
      public static byte[] showGuildRanks(byte type, MapleClient c, MapleGuildRanking ranks) {
         ...
         if (type != 1 && type != 2) {
            if (type == 5) {
               ...
               mplew.writeInt(g.getNoblessSkillPoint());
               mplew.writeInt(3);
               mplew.writeInt(0);
               mplew.writeInt(0);
               mplew.writeInt(0);
            ...
            for(int i = 0; i < 3; ++i) {
               ...
               if (rank == null) {
                  ...
                  Iterator var6 = rank.iterator();

                  while(var6.hasNext()) {
                     MapleGuildRanking.GuildRankingInfo info = (MapleGuildRanking.GuildRankingInfo)var6.next();
      ...
      public static byte[] RecruitmentGuild(MapleCharacter chr) {
         ...
         for(Iterator var3 = World.Guild.getGuilds().iterator(); var3.hasNext(); ++i) {
            MapleGuild guild = (MapleGuild)var3.next();
            mplew.writeInt(guild.getId());
            mplew.write(guild.getLevel());
            mplew.writeMapleAsciiString(guild.getName());
      ...
      public static byte[] RequestListGuild(List<MapleGuild> g) {
         ...
         while(var2.hasNext()) {
            MapleGuild guild = (MapleGuild)var2.next();
            mplew.writeInt(guild.getId());
            mplew.write(guild.getLevel());
            mplew.writeMapleAsciiString(guild.getName());
            mplew.writeMapleAsciiString(guild.getLeaderName());
      ...
      public static byte[] showSearchGuildInfo(MapleCharacter chr, List<MapleGuild> gss, String text, byte mode, int option) {
         ...
         Iterator var6 = gss.iterator();

         while(var6.hasNext()) {
            MapleGuild gs = (MapleGuild)var6.next();
      ...
      public static byte[] updateGP(int gid, int contribution, int GP, int glevel) {
         MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
         mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
         mplew.write((int)152);
         mplew.writeInt(gid);
         ...
         mplew.writeInt(glevel);
         mplew.writeLong((long)GP);
         return mplew.getPacket();
      }

      public static byte[] GainGP(MapleGuild guild, MapleCharacter chr, int amount) {
         MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
         mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
         mplew.write((int)130);
         mplew.writeInt(guild.getId());
      ...
      public static byte[] guildAattendance(MapleGuild guild, MapleCharacter chr) {
         MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
         mplew.writeShort(SendPacketOpcode.GUILD_OPERATION.getValue());
         mplew.write((int)183);
         mplew.writeInt(guild.getId());
   ...
   public static class InfoPacket {
      ...
      public static byte[] updateQuestMobKills(MapleQuestStatus status) {
         ...
         Iterator iterator = status.getMobKills().values().iterator();

         while(iterator.hasNext()) {
            int kills = (Integer)iterator.next();
      ...
      public static byte[] GainEXP_Monster(MapleCharacter chr, long gain, boolean white, long flag, int eventBonusExp, int weddingExp, int partyExp, int itemEquipExp, int pcExp, int rainbowWeekExp, int boomupExp, int portionExp, int skillExp, int buffExp, int restExp, int itemExp, int valueExp, long bonusExp, long bloodExp, int iceExp, Pair<Integer, Integer> burningExp, int hpLiskExp, int fieldBonusExp, int eventBonusExp2, int fieldBonusExp2) {
         ...
         if ((flag & 1L) != 0L) {
            packet.writeLong((long)eventBonusExp);
         }
         ...
         if ((flag & 16L) != 0L) {
            packet.writeLong((long)weddingExp);
         }

         if ((flag & 32L) != 0L) {
            packet.writeLong((long)partyExp);
         }

         if ((flag & 64L) != 0L) {
            packet.writeLong((long)itemEquipExp);
         }

         if ((flag & 128L) != 0L) {
            packet.writeLong((long)pcExp);
         }

         if ((flag & 256L) != 0L) {
            packet.writeLong((long)rainbowWeekExp);
         }

         if ((flag & 512L) != 0L) {
            packet.writeLong((long)boomupExp);
         }

         if ((flag & 1024L) != 0L) {
            packet.writeLong((long)portionExp);
         }

         if ((flag & 2048L) != 0L) {
            packet.writeLong((long)skillExp);
         }

         if ((flag & 4096L) != 0L) {
            packet.writeLong((long)buffExp);
         }

         if ((flag & 8192L) != 0L) {
            packet.writeLong((long)restExp);
         }

         if ((flag & 16384L) != 0L) {
            packet.writeLong((long)itemExp);
         }

         if ((flag & 65536L) != 0L) {
            packet.writeLong(14L);
         }

         if ((flag & 131072L) != 0L) {
            packet.writeLong((long)valueExp);
         }

         if ((flag & 262144L) != 0L) {
            packet.writeLong(16L);
         }
         ...
         if ((flag & 2097152L) != 0L) {
            packet.writeLong((long)iceExp);
         }

         if ((flag & 4194304L) != 0L) {
            packet.writeLong((long)(Integer)burningExp.left);
            packet.writeInt((Integer)burningExp.right);
         }

         if ((flag & 8388608L) != 0L) {
            packet.writeLong((long)hpLiskExp);
         }

         if ((flag & 16777216L) != 0L) {
            packet.writeLong((long)fieldBonusExp);
         }

         if ((flag & 33554432L) != 0L) {
            packet.writeLong(23L);
         }

         if ((flag & 67108864L) != 0L) {
            packet.writeLong((long)eventBonusExp2);
         }

         if ((flag & 134217728L) != 0L) {
            packet.writeLong(25L);
         }

         if ((flag & 268435456L) != 0L) {
            packet.writeLong((long)fieldBonusExp2);
         }

         if ((flag & 536870912L) != 0L) {
            packet.writeLong(27L);
         }

         if ((flag & 1073741824L) != 0L) {
            packet.writeLong(28L);
         }
      ...
      public static byte[] showTraitMaxed(MapleTrait.MapleTraitType trait) {
         ...
         mplew.writeShort(SendPacketOpcode.SHOW_STATUS_INFO.getValue());
         mplew.write((int)19);
         mplew.writeLong((long)trait.getStat().getValue());
         return mplew.getPacket();
      }
   ...
   public static class BuffPacket {
      ...
      public static byte[] giveBuff(Map<SecondaryStat, Pair<Integer, Integer>> statups, SecondaryStatEffect effect, MapleCharacter chr) {
         ...
         PacketHelper.writeBuffMask(mplew, (Collection)newstatups);
         Iterator var5 = newstatups.iterator();
         ...
         while(true) {
                  ...
                  do {
                     if (!var5.hasNext()) {
                        ...
                        if (statups.containsKey(SecondaryStat.Judgement)) {
                           if ((Integer)((Pair)statups.get(SecondaryStat.Judgement)).left == 1) {
                              mplew.writeInt(effect.getV());
                           } else if ((Integer)((Pair)statups.get(SecondaryStat.Judgement)).left == 2) {
                              mplew.writeInt(effect.getW());
                           } else if ((Integer)((Pair)statups.get(SecondaryStat.Judgement)).left == 3) {
                        ...
                        if (statups.containsKey(SecondaryStat.LifeTidal)) {
                           switch((Integer)((Pair)statups.get(SecondaryStat.LifeTidal)).left) {
                           case 1:
                        ...
                        if (statups.containsKey(SecondaryStat.Larkness)) {
                           mplew.writeInt(effect.getSourceId());
                           mplew.writeInt(effect.getDuration());
                           mplew.writeInt(effect.getSourceId() != 20040216 && effect.getSourceId() != 20040217 ? (effect.getSourceId() == 20040219 ? 20040220 : 20040219) : 0);
                           mplew.writeInt(effect.getDuration());
                           mplew.writeInt(effect.getSourceId() == 20040217 ? 10000 : -1);
                           mplew.writeInt(effect.getSourceId() == 20040216 ? -1 : 1);
                           mplew.writeInt(chr.getSkillLevel(400021005) <= 0 || chr.getUseTruthDoor() || effect.getSourceId() != 20040219 && effect.getSourceId() != 20040220 ? 0 : 1);
                        }
                        ...
                        if (statups.containsKey(SecondaryStat.MobZoneState)) {
                           mplew.writeInt((Integer)((Pair)statups.get(SecondaryStat.MobZoneState)).right);
                           mplew.writeInt(-1);
                        }
                        ...
                        if (statups.containsKey(SecondaryStat.ImmuneBarrier)) {
                           mplew.writeInt((Integer)((Pair)statups.get(SecondaryStat.ImmuneBarrier)).left);
                        }
                        ...
                        if (statups.containsKey(SecondaryStat.RoyalGuardState)) {
                           mplew.writeInt((Integer)((Pair)statups.get(SecondaryStat.IndiePad)).left);
                           mplew.writeInt((Integer)((Pair)statups.get(SecondaryStat.RoyalGuardState)).left);
                        }

                        boolean unk;
                        if (statups.containsKey(SecondaryStat.MichaelSoulLink)) {
                           unk = chr.getParty() != null;
                           int size = 0;
                           if (unk) {
                              Iterator var7 = chr.getParty().getMembers().iterator();
                              ...
                              while(true) {
                                 ...
                                 do {
                                    ...
                                    chr1 = (MaplePartyCharacter)var7.next();
                                    chr2 = chr.getMap().getCharacter(chr1.getId());
                                 } while((!chr1.isOnline() || !chr2.getBuffedValue(51111008)) && (chr.getTruePosition().x + effect.getLt().x >= chr2.getTruePosition().x || chr.getTruePosition().x - effect.getLt().x <= chr2.getTruePosition().x || chr.getTruePosition().y + effect.getLt().y >= chr2.getTruePosition().y || chr.getTruePosition().y - effect.getLt().y <= chr2.getTruePosition().y));

                                 ++size;
                              }
                           }

                           mplew.writeInt(unk ? chr.getParty().getMembers().size() : 1);
                           mplew.write(size >= 2 ? 0 : 1);
                           mplew.writeInt(unk ? chr.getParty().getId() : 0);
                           mplew.writeInt(0);
                        }
                        ...
                        while(true) {
                           while(true) {
                              do {
                                 do {
                                    if (!var5.hasNext()) {
                                       ...
                                       mplew.write(true);
                                       mplew.write(true);
                                       Iterator var15 = statups.entrySet().iterator();

                                       while(var15.hasNext()) {
                                          Entry<SecondaryStat, Pair<Integer, Integer>> stat = (Entry)var15.next();
                                          if (GameConstants.MovementAffectingStat((SecondaryStat)stat.getKey())) {
                                    ...
                                    stat = (Pair)var5.next();
                                 } while(((SecondaryStat)stat.left).canStack());
                              } while(!((SecondaryStat)stat.left).isSpecialBuff());

                              mplew.writeInt((Integer)((Pair)stat.right).left);
                              ...
                              if (stat.left == SecondaryStat.GuidedBullet) {
                                 ...
                                 mplew.writeInt(0);
                              } else if (stat.left != SecondaryStat.RideVehicleExpire && stat.left != SecondaryStat.PartyBooster && stat.left != SecondaryStat.DashJump && stat.left != SecondaryStat.DashSpeed) {
                                 if (stat.left == SecondaryStat.Grave) {
                                    mplew.writeInt(chr.graveObjectId);
                                    mplew.writeInt(0);
                                 }
                              } else {
                                 mplew.writeShort((Integer)((Pair)stat.right).right / 1000);
                              }
                           }
                        }
                     }
                     ...
                     stat = (Pair)var5.next();
                  } while(((SecondaryStat)stat.getLeft()).canStack());
               } while(((SecondaryStat)stat.getLeft()).isSpecialBuff());
            } while(statups.containsKey(SecondaryStat.PinkbeanRollingGrade));

            if (!SecondaryStat.isEncode4Byte(statups) && (stat.getLeft() != SecondaryStat.IgnisRore || effect.getSourceId() != 400031017)) {
               mplew.writeShort((Integer)((Pair)stat.getRight()).left);
            } else {
               mplew.writeInt((Integer)((Pair)stat.getRight()).left);
            }
            ...
            if (stat.getLeft() != SecondaryStat.KinesisPsychicPoint && !((SecondaryStat)stat.getLeft()).SpectorEffect() && stat.getLeft() != SecondaryStat.HoyoungThirdProperty && stat.getLeft() != SecondaryStat.TidalForce && stat.getLeft() != SecondaryStat.YetiAnger && stat.getLeft() != SecondaryStat.YetiAngerMode) {
               if (stat.getLeft() == SecondaryStat.CardinalMark) {
            ...
            mplew.writeInt(effect == null ? 0 : (Integer)((Pair)stat.right).right);
         }
      }
      ...
      public static byte[] giveDisease(Map<SecondaryStat, Pair<Integer, Integer>> statups, MobSkill skill, MapleCharacter chr) {
         ...
         while(var5.hasNext()) {
            pair = (Pair)var5.next();
            if (!((SecondaryStat)pair.getLeft()).canStack() && !((SecondaryStat)pair.getLeft()).isSpecialBuff()) {
               if (SecondaryStat.isEncode4Byte(statups)) {
                  if (pair.left == SecondaryStat.ReturnTeleport) {
                     ...
                     mplew.writeInt(((SecondaryStat)pair.getLeft()).getX() != 0 ? ((SecondaryStat)pair.getLeft()).getX() : (Integer)((Pair)pair.getRight()).left);
                  }
               } else {
                  mplew.writeShort((Integer)((Pair)pair.getRight()).left);
               }
         ...
         mplew.write(true);
         mplew.write(true);
         var5 = statups.entrySet().iterator();
      ...
      public static void encodeIndieTempStat(MaplePacketLittleEndianWriter mplew, List<Pair<SecondaryStat, Pair<Integer, Integer>>> newstatups, MapleCharacter chr) {
         HashMap<SecondaryStat, List<SecondaryStatValueHolder>> indiestats = new HashMap();
         newstatups.stream().filter((statup) -> {
            return ((SecondaryStat)statup.getLeft()).canStack();
         }).map((statup) -> {
            indiestats.put((SecondaryStat)statup.getLeft(), new ArrayList());
            return statup;
         }).forEach((statup) -> {
            Iterator effects = chr.getEffects().iterator();

            while(effects.hasNext()) {
               Pair<SecondaryStat, SecondaryStatValueHolder> effect = (Pair)effects.next();
               if (statup.getLeft() == effect.left) {
                  ((List)indiestats.get(statup.getLeft())).add((SecondaryStatValueHolder)effect.right);
               }
            }

         });
         List<Pair<SecondaryStat, List<SecondaryStatValueHolder>>> indiestatz = PacketHelper.sortIndieBuffStats(indiestats);
         Iterator var5 = indiestatz.iterator();

         while(var5.hasNext()) {
            Pair<SecondaryStat, List<SecondaryStatValueHolder>> indiestat = (Pair)var5.next();
            mplew.writeInt(((List)indiestat.getRight()).size());
            Iterator var7 = ((List)indiestat.getRight()).iterator();

            while(var7.hasNext()) {
               SecondaryStatValueHolder indie = (SecondaryStatValueHolder)var7.next();
               int sourceid = 0;
               if (indie.effect.getSourceId() == 400011127) {
                  if (indiestat.getLeft() == SecondaryStat.IndieDamR) {
                     ...
                     indie.list1.add(new Pair(1, 2));
                     indie.list1.add(new Pair(2, 8738));
                     indie.list1.add(new Pair(3, 3520));
                  }
               }

               if (!((SecondaryStat)indiestat.getLeft()).isItemEffect() && indie.effect.isSkill() && SkillFactory.getSkill(indie.effect.getSourceId()) != null) {
               ...
               Iterator var10 = indie.list1.iterator();

               Pair list;
               while(var10.hasNext()) {
                  list = (Pair)var10.next();
                  mplew.writeInt((Integer)list.left);
                  mplew.writeInt((Integer)list.right);
               }

               mplew.writeInt(indie.list2.size());
               var10 = indie.list2.iterator();
      ...
      private static void giveDice(MaplePacketLittleEndianWriter mplew, SecondaryStatEffect effect, MapleCharacter chr) {
         ...
         if (dice != 3 && doubledice != 3 && thirddice != 3) {
            mplew.writeInt(0);
         } else if (dice == 3 && doubledice == 3 && thirddice == 3) {
         ...
         if (dice != 4 && doubledice != 4 && thirddice != 4) {
            mplew.writeInt(0);
         } else if (dice == 4 && doubledice == 4 && thirddice == 4) {
         ...
         if (dice != 2 && doubledice != 2 && thirddice != 2) {
            mplew.writeInt(0);
         } else if (dice == 2 && doubledice == 2 && thirddice == 2) {
         ...
         if (dice != 5 && doubledice != 5 && thirddice != 5) {
            mplew.writeInt(0);
         } else if (dice == 5 && doubledice == 5 && thirddice == 5) {
         ...
         if (dice != 6 && doubledice != 6 && thirddice != 6) {
            mplew.writeInt(0);
         } else if (dice == 6 && doubledice == 6 && thirddice == 6) {
         ...
         if (dice != 7 && doubledice != 7 && thirddice != 7) {
            mplew.writeInt(0);
         } else if (dice == 7 && doubledice == 7 && thirddice == 7) {
      ...
      public static byte[] cancelBuff(Map<SecondaryStat, Pair<Integer, Integer>> statups, MapleCharacter chr) {
         ...
         PacketHelper.writeBuffMask(mplew, (Collection)newstatups);
         encodeIndieTempStat(mplew, newstatups, chr);
         Iterator var4 = statups.entrySet().iterator();

         while(var4.hasNext()) {
            Entry<SecondaryStat, Pair<Integer, Integer>> stat = (Entry)var4.next();
            if (GameConstants.MovementAffectingStat((SecondaryStat)stat.getKey())) {
               mplew.write((int)1);
               break;
            }
   ...
   public static class InventoryPacket {
      ...
      public static byte[] moveInventoryItem(MapleInventoryType type, List<Pair<Short, Short>> updateSlots) {
         ...
         mplew.writeShort(0);
         mplew.write((int)0);
         Iterator var3 = updateSlots.iterator();

         while(var3.hasNext()) {
            Pair<Short, Short> updateSlot = (Pair)var3.next();
            mplew.write((int)2);
            mplew.write(Math.max(1, type.getType()));
            mplew.writeShort((Short)updateSlot.left);
            mplew.writeShort((Short)updateSlot.right);
         }
