...
public class Equip extends Item implements Serializable {
   ...
   public byte getLevel() {
      return this.getItemId() >= 1113098 && this.getItemId() <= 1113128 ? 0 : this.level;
   }
   ...
   public int getExpPercentage() {
      return this.getEquipLevel() >= this.getBaseLevel() && this.getEquipLevel() <= GameConstants.getMaxLevel(this.getItemId()) && GameConstants.getExpForLevel(this.getEquipLevel(), this.getItemId()) > 0 ? this.getEquipExpForLevel() * 100 / GameConstants.getExpForLevel(this.getEquipLevel(), this.getItemId()) : 0;
   }
   ...
   public int getEquipLevel() {
      if (GameConstants.getMaxLevel(this.getItemId()) <= 0) {
         ...
         for(int i = levelz; i <= GameConstants.getMaxLevel(this.getItemId()) && expz >= GameConstants.getExpForLevel(i, this.getItemId()); ++i) {
            ++levelz;
            expz -= GameConstants.getExpForLevel(i, this.getItemId());
         }
   ...
   public int getBaseLevel() {
      return this.getItemId() >= 1113098 && this.getItemId() <= 1113128 ? this.level : 0;
   }
   ...
   public long newRebirth(int reqLevel, int scrollId, boolean update) {
      if (!GameConstants.isRing(this.getItemId()) && this.getItemId() / 1000 != 1092 && this.getItemId() / 1000 != 1342 && this.getItemId() / 1000 != 1713 && this.getItemId() / 1000 != 1712 && this.getItemId() / 1000 != 1152 && this.getItemId() / 1000 != 1142 && this.getItemId() / 1000 != 1143 && this.getItemId() / 1000 != 1672 && !GameConstants.isSecondaryWeapon(this.getItemId()) && this.getItemId() / 1000 != 1190 && this.getItemId() / 1000 != 1191 && this.getItemId() / 1000 != 1182 && this.getItemId() / 1000 != 1662 && this.getItemId() / 1000 != 1802) {
         ...
         for(int i = 0; i < 4; ++i) {
            int randomOption;
            for(randomOption = Randomizer.nextInt(25); rebirthOptions[0] == randomOption || rebirthOptions[1] == randomOption || rebirthOptions[2] == randomOption || rebirthOptions[3] == randomOption || randomOption == 12 || randomOption == 14 || randomOption == 15 || randomOption == 16 || !GameConstants.isWeapon(this.getItemId()) && (randomOption == 21 || randomOption == 23); randomOption = Randomizer.nextInt(25)) {
            }

            rebirthOptions[i] = randomOption;
            int randomValue = false;
            int randomValue = (randomOption != 17 && randomOption != 18 || GameConstants.isWeapon(this.getItemId())) && randomOption != 22 ? Randomizer.rand(3, maxValue) : Randomizer.rand(1, maxValue);
            rebirth[i] = (long)(randomOption * 10 + randomValue);
