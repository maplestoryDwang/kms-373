...
public class MapleReactorFactory {
   ...
   public static final MapleReactorStats getReactor(int rid) {
      MapleReactorStats stats = (MapleReactorStats)reactorStats.get(rid);
      if (stats == null) {
         int infoId = rid;
         ...
         if (stats == null) {
            ...
            while(true) {
               ...
               if (reactorInfoData_ != null && reactorInfoData_.getChildByPath("0") != null) {
                  ...
                  foundState = true;
                  stats.addState(i, type, reactItem, (byte)MapleDataTool.getIntConvert("state", reactorInfoData), MapleDataTool.getIntConvert("timeOut", reactorInfoData_, -1), (byte)(canTouch ? 2 : (MapleDataTool.getIntConvert("2", reactorInfoData, 0) <= 0 && reactorInfoData.getChildByPath("clickArea") == null && type != 9 ? 0 : 1)));
               } else {
                  stats.addState(i, 999, (Pair)null, (byte)(foundState ? -1 : i + 1), 0, (byte)0);
               }
