...
public class MapleSummon extends AnimatedMapleMapObject {
   ...
   public MapleSummon(MapleCharacter owner, int sourceid, Point pos, SummonMovementType movementType, byte rltype, int duration) {
      ...
      this.controlCrystal = false;
      this.noapply = false;
      this.SpecialSkill = false;
      this.energy = 0;
      this.mechAddAttackCount = 0;
      this.changePositionCount = 0;
      this.magicSkills = new ArrayList();
      this.crystalSkills = new ArrayList();
      this.owner = owner;
      this.skill = sourceid;
   ...
   public final boolean isMultiAttack() {
      return this.skill == 35111002 || this.skill == 35121003 || this.skill == 61111002 || this.skill == 61111220 || !this.isGaviota() && this.skill != 33101008 && this.skill < 35000000 || this.skill == 35111009 || this.skill == 35111010 || this.skill == 35111001;
   }
   ...
   public final void removeSummon(MapleMap map, boolean changechannel) {
      this.removeSummon(map, true, changechannel);
   }
   ...
   public void setEnergy(int energy) {
      this.energy = energy;
      this.owner.setSkillCustomInfo(152101000, (long)energy, 0L);
   }
