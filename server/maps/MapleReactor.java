...
public class MapleReactor extends MapleMapObject {
   ...
   public void forceHitReactor1(byte newState) {
      this.setState(newState);
      this.setTimerActive(false);
      this.map.broadcastMessage(CField.triggerReactor1(this, 0));
   }
         ...
         if (this.stats.getType(this.state) != 2 || charPos != 0 && charPos != 2) {
            ...
            if (this.stats.getNextState(this.state) != -1 && this.stats.getType(this.state) != 999) {
               ...
               if (this.stats.getTimeOut(this.state) > 0) {
                  ...
                  this.scheduleSetState(this.state, oldState, (long)this.stats.getTimeOut(this.state), c);
               }
            } else {
   ...
   public String toString() {
      ...
      return "Reactor " + var10000 + " of id " + this.rid + " at position " + this.getPosition().toString() + " state" + this.state + " type " + this.stats.getType(this.state);
   }
