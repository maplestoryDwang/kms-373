...
public class MapleMapItem extends MapleMapObject {
   ...
   public void sendSpawnData(MapleClient client) {
      if ((this.questid <= 0 || client.getPlayer().getQuestStatus(this.questid) == 1) && (this.publicDropId <= 0 || this.publicDropId > 0 && client.getAccID() == this.publicDropId)) {
         client.getSession().writeAndFlush(CField.dropItemFromMapObject(client.getPlayer().getMap(), this, (Point)null, this.getTruePosition(), (byte)2, client.getPlayer().getBuffedEffect(SecondaryStat.PickPocket) != null));
      }
