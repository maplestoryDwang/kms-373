...
public class MapleFootholdTree {
   ...
   private final MapleFoothold findWallR(Point p1, Point p2) {
      Iterator var3 = this.footholds.iterator();

      while(var3.hasNext()) {
         MapleFoothold f = (MapleFoothold)var3.next();
   ...
   public final boolean checkRelevantFH(short fromx, short fromy, short tox, short toy) {
      ...
      Iterator var6 = this.footholds.iterator();

      MapleFoothold fh2;
      while(var6.hasNext()) {
         fh2 = (MapleFoothold)var6.next();
         if (fh2.getX1() <= fromx && fh2.getX2() >= fromx && fh2.getY1() <= fromy && fh2.getY2() >= fromy) {
            fhdata = fh2;
            break;
         }
      }

      var6 = this.footholds.iterator();
      ...
      do {
         ...
         fh2 = (MapleFoothold)var6.next();
      } while(fh2.getX1() > tox || fh2.getX2() < tox || fh2.getY1() > toy || fh2.getY2() < toy);
   ...
   public final MapleFoothold findBelow(Point p) {
      ...
      Iterator var4 = relevants.iterator();

      MapleFoothold fh;
      while(var4.hasNext()) {
         fh = (MapleFoothold)var4.next();
      ...
      do {
         do {
            ...
            if (!fh.isWall() && fh.getY1() != fh.getY2()) {
               ...
               double s4 = (double)Math.abs(p.x - fh.getX1());
