...
public class MapleMonsterStats {
   ...
   public void setSkills(List<MobSkill> skills2) {
      Iterator var2 = skills2.iterator();

      while(var2.hasNext()) {
         MobSkill skill = (MobSkill)var2.next();
   ...
   public MobSkill getSkill(int skillId, int level) {
      Iterator var3 = this.skills.iterator();
      ...
      do {
         ...
         skill = (MobSkill)var3.next();
      } while(skill.getSkillId() != skillId || skill.getSkillLevel() != level);
