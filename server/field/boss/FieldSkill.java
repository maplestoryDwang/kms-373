...
public class FieldSkill {
   ...
   private List<FieldSkill.SummonedSequenceInfo> summonedSequenceInfoList = new ArrayList();
   private List<FieldSkill.FieldFootHold> footHolds = new ArrayList();
   private List<FieldSkill.LaserInfo> laserInfoList = new ArrayList();
   private List<MapleNodes.Environment> envInfo = new ArrayList();
   private List<FieldSkill.ThunderInfo> thunInfo = new ArrayList();
   ...
   public void addSummonedSequenceInfoList(FieldSkill.SummonedSequenceInfo info) {
      this.summonedSequenceInfoList.add(info);
   }

   public List<FieldSkill.SummonedSequenceInfo> getSummonedSequenceInfoList() {
      return this.summonedSequenceInfoList;
   }

   public void setSummonedSequenceInfoList(List<FieldSkill.SummonedSequenceInfo> summonedSequenceInfoList) {
      this.summonedSequenceInfoList = summonedSequenceInfoList;
   }

   public List<FieldSkill.LaserInfo> getLaserInfoList() {
      return this.laserInfoList;
   }

   public void setLaserInfoList(List<FieldSkill.LaserInfo> infoList) {
      this.laserInfoList = infoList;
   }

   public List<FieldSkill.FieldFootHold> getFootHolds() {
      return this.footHolds;
   }

   public void setFootHolds(List<FieldSkill.FieldFootHold> footHolds) {
   ...
   public List<FieldSkill.ThunderInfo> getThunderInfo() {
      return this.thunInfo;
   }

   public void setThunderInfo(List<FieldSkill.ThunderInfo> thunInfo) {
      this.thunInfo = thunInfo;
   }

   public void addThunderInfo(FieldSkill.ThunderInfo info) {
