...
public class MapleOrb extends MapleMapObject {
   ...
   public void sendSpawnData(MapleClient client) {
      client.getSession().writeAndFlush(CField.spawnOrb(this.cid, Arrays.asList(this)));
   }

   public void sendDestroyData(MapleClient client) {
      client.getSession().writeAndFlush(CField.removeOrb(this.cid, Arrays.asList(this)));
   }
