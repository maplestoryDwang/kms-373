...
public class SecondAtom extends MapleMapObject {
   ...
   public void sendSpawnData(MapleClient client) {
      client.getSession().writeAndFlush(CField.spawnSecondAtoms(this.ownerId, Arrays.asList(this), this.spawnType));
   }

   public void sendDestroyData(MapleClient client) {
      client.getSession().writeAndFlush(CField.removeSecondAtom(this.ownerId, this.getObjectId()));
   }
