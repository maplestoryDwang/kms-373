      ...
      Timer.EventTimer.getInstance().schedule(new Runnable() {
         public void run() {
            if (c.getPlayer().getMapId() == 993000000) {
               ...
               Iterator iterator = ((List)BountyHunting.this.waveData.get(BountyHunting.this.stage - 1)).iterator();
            ...
            if (c != null && c.getPlayer() != null && c.getPlayer().getMap() != null && c.getPlayer().getMap().getNumMonsters() == 0) {
               if (BountyHunting.this.stage < 5 && c.getPlayer().getMapId() == 993000000) {
                  ...
                  Timer.EventTimer.getInstance().schedule(new Runnable() {
                     ...
                     public void run() {
                        if (this.this$1.val$c != null && this.this$1.val$c.getPlayer() != null && this.this$1.val$c.getPlayer().getMapId() == 993000000) {
