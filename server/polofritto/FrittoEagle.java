      ...
      this.sch = Timer.EventTimer.getInstance().register(new Runnable() {
         public void run() {
            if (c != null && c.getPlayer() != null && c.getPlayer().getMap() != null) {
               int size = 0;
               Iterator var2 = c.getPlayer().getMap().getAllMonster().iterator();

               while(var2.hasNext()) {
                  MapleMonster m = (MapleMonster)var2.next();
               ...
               if (FrittoEagle.this.score >= 1000 || c.getPlayer().getMap().getNumMonsters() == 0 || size == 0) {
                  ...
                  Timer.EventTimer.getInstance().schedule(new Runnable() {
                     ...
                     public void run() {
                        if (this.this$1.val$c != null && this.this$1.val$c.getPlayer() != null) {
                           this.this$1.val$c.getSession().writeAndFlush(SLFCGPacket.SetIngameDirectionMode(false, true, false, false));
                           this.this$1.val$c.getSession().writeAndFlush(SLFCGPacket.InGameDirectionEvent("", 10, 0));
                           this.this$1.val$c.getPlayer().warp(993000601);
                        }
